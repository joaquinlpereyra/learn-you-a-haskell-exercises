...
allColours =  [Red, Orange, Yellow, Green, Blue, Indigo, Violet]
orderedColours = [minimum allColours .. maximum allColours]
...
firstColour = minimum [Red, Orange, Yellow, Green, Blue, Indigo, Violet]

-- List the colours in reverse order
reverseColourOrder = reverse orderedColours
